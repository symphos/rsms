    ...
    P: Clone + Send + Sync + 'static,
{
    ...
    pub async fn try_offer(&self, key: K, params: P) -> WindowResult<WindowFuture<K, P>> {
    ...
    pub async fn offer(&self, key: K, params: P, timeout: Duration) -> WindowResult<WindowFuture<K, P>> {
